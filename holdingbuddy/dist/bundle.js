(function (factory) {
    ...
    class Controls {
        ...
        set trackInputSelector(selector) {
            ...
            (_a = document.querySelector(selector)) === null || _a === void 0 ? void 0 : _a.addEventListener('change', (evt) => {
                ...
                const track = Number.parseInt(evt.target.value);
                this.trackChangedHandlers
                    .forEach(h => h(this.track, track));
                this.track = track;
            });
        }
        set headingInputSelector(selector) {
            var _a;
            (_a = document.querySelector(selector)) === null || _a === void 0 ? void 0 : _a.addEventListener('change', (evt) => {
                // TODO more validation
                const heading = Number.parseInt(evt.target.value);
                this.headingChangedHandlers
    ...
    ***/
     ...
     */
    function getSegmentPath(cx, cy, radius, thetaDeg, centreDeg) {
    ...
    function labelSegment(segment, label, group) {
    ...
    class Segment {
        ...
        static headingBetween(start, end, heading) {
    ...
    const COS_30 = 0.866;
    class Chart {
        constructor(chartSelector, width, height) {
            this.width = width;
            this.height = height;
            ...
            this.svg = SVG().addTo(chartSelector);
            this.svg.viewbox(0, 0, width, height);
            this.defs = new Defs$1(this.svg);
        }
        set inboundTrackChangedHandler(handler) {
            this._inboundTrackChangedHandler = handler;
        }
        set headingChangedHandler(handler) {
        ...
        drawHoldingPattern() {
            ...
            */
            ...
            //   <
            // 270
            const textAboveArrow = (marker, trackDeg) => {
            ...
            const textBelowArrow = (marker, trackDeg) => {
                const group = marker.group();
                group.text(txt => {
                    txt.tspan(trackDeg.toString() + '°')
                        .attr('text-anchor', 'start');
    ...
    class Timer {
        constructor(timerButtonSelector, overlaySelector, lcdSelector) {
            ...
            (_c = document.querySelector(`${overlaySelector} .reset`)) === null || _c === void 0 ? void 0 : _c.addEventListener('click', (evt) => {
                this.minutes = this.seconds = 0;
                this.lcd.innerHTML = this.formattedTime;
            });
            // Clicking on the lcd screen hides the timer
            (_d = document.querySelector(`${overlaySelector} .lcd`)) === null || _d === void 0 ? void 0 : _d.addEventListener('click', (evt) => {
                this.hideOverlay();
            });
            (_e = document.querySelector(timerButtonSelector)) === null || _e === void 0 ? void 0 : _e.addEventListener('click', (evt) => {
    ...
    window.onload = () => {
        var _a, _b, _c;
        (_a = document.querySelector(updateId + ' .update')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', (evt) => {
            reload();
        });
        (_b = document.querySelector(".close")) === null || _b === void 0 ? void 0 : _b.addEventListener('click', (evt) => {
            document.querySelector(updateId).style.visibility = 'hidden';
        });
        const chart = new Chart(chartId, 400, 400);
        chart.inboundTrackChangedHandler = (track) => {
            document.querySelector(trackId).value = track.toString();
        };
        chart.headingChangedHandler = (heading) => {
            document.querySelector(headingId).value = heading.toString();
        };
        chart.draw();
        ...
        controls.addHeadingChangedHandler((_, newHeading) => {
            chart.heading = newHeading;
        });
        const mc = new hammer(document.querySelector(svgSelector));
    ...
    function showUpdateAvailable() {
        document.querySelector(updateId).style.visibility = 'visible';
    }
    function reload() {
        if (newWorker) {
